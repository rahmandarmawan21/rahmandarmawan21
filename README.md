<h2> Hi, I'm M Rahman Darmawan! <img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"></h2>
...
const rahman = {
  pronouns: "he" | "him",
  code: [Javascript, Typescript, Groovy, Python, Java, PostgreSQL],
  tools: [VSCode, DBver, Postman, Jmeter, Jira],
  method: {
            manual: "Test case development and execute test",
            automation: "Scripting automation to coverage test and running for maintain",
            database_validation: "verify data"
          },
...
<code><img height="20" alt="Cucumber" src="https://raw.githubusercontent.com/devicons/devicon/master/icons/cucumber/cucumber-plain.svg"></code>
---
